...
2. TOP WATERCOLOR IMAGE:
   - Centered horizontally, positioned in the top 20% of the page
   - About 1800px wide × 540px tall
   - Content: ${coverArt.topImage}
   - The watercolor FADES and DISSOLVES naturally into the ivory background on ALL sides — no hard edges, no frame. Like wet paint bleeding into paper.

3. GOLD SEPARATOR LINE:
   - Thin horizontal gold line below the watercolor, centered
...
2. TOP WATERCOLOR IMAGE:
   ...
   - The watercolor FADES naturally into ivory (#F5EDE4) on all sides — no hard edges, no frame.
