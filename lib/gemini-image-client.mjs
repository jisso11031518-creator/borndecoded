...
export async function generateCoverImage(coverArt, product) {
  ...
  if (openaiKey) {
    // Use same prompt as Gemini (without EXACT size line — DALL-E uses API size param)
    const dallePrompt = `Create a decorative page background for a premium astrology PDF report. Portrait orientation.
