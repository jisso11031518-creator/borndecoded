...
// ---- Ligature Breaker ----
// Insert zero-width non-joiner (U+200C) between characters that form ligatures
function breakLigatures(text) {
  if (!text || typeof text !== 'string') return '';
  // Common ligature pairs: Th, Tf, fi, fl, ff, ffi, ffl, ft
  return text
    .replace(/Th/g, 'T\u200Ch')
    .replace(/TH/g, 'T\u200CH')
    .replace(/ffi/g, 'f\u200Cf\u200Ci')
...
// ---- Text Sanitizer: remove CJK + break ligatures ----
function clean(text) {
  if (!text) return '';
...
const s = StyleSheet.create({
  ...
  coverBrand: { fontFamily: 'GreatVibes', fontSize: 30, color: GOLD, marginBottom: 5 },
  coverTagline: { fontFamily: 'Cormorant', fontSize: 10, color: GOLD, letterSpacing: 3, marginBottom: 10 },
  coverDivider: { height: 1, backgroundColor: GOLD, opacity: 0.4, marginBottom: 12, marginHorizontal: 80 },
  coverProduct: { fontFamily: 'Cormorant', fontSize: 13, color: MUTED, marginBottom: 14 },
  coverName: { fontFamily: 'GreatVibes', fontSize: 26, color: BROWN, marginBottom: 4 },
  coverDate: { fontFamily: 'Cormorant', fontSize: 12, color: MUTED },

  // ---- Body ----
  body: { position: 'relative', padding: '50 52 45 52', flex: 1 },

  // Section title
  sectionTitle: { fontFamily: 'GreatVibes', fontSize: 28, color: GOLD, textAlign: 'center', marginBottom: 4 },
  goldLine: { height: 1, backgroundColor: GOLD, opacity: 0.3, marginBottom: 12, marginTop: 2 },
  sectionSpacer: { height: 28 },

  // Subtitle
  subTitle: { fontFamily: 'Lora', fontSize: 13.5, color: BROWN, marginBottom: 5, marginTop: 12 },

  // Body text — large for mobile
  text: { fontFamily: 'Cormorant', fontSize: 13, color: BROWN, lineHeight: 1.7, marginBottom: 6, textAlign: 'justify' },
  textSmall: { fontFamily: 'Cormorant', fontSize: 11.5, color: MUTED, lineHeight: 1.6, marginBottom: 4 },

  // Metaphor
  metaphor: { fontFamily: 'GreatVibes', fontSize: 19, color: GOLD, textAlign: 'center', marginBottom: 10, marginTop: 2 },

  // Q&A
  question: { fontFamily: 'Lora', fontSize: 12.5, color: GOLD, marginBottom: 3, marginTop: 10 },
  answer: { fontFamily: 'Cormorant', fontSize: 13, color: BROWN, lineHeight: 1.7, marginBottom: 6 },

  // Bullet
  bullet: { fontFamily: 'Cormorant', fontSize: 13, color: BROWN, lineHeight: 1.7, marginBottom: 3, paddingLeft: 14 },

  // Closing (inline with survival guide)
  closingMsg: { fontFamily: 'GreatVibes', fontSize: 16, color: GOLD, textAlign: 'center', marginTop: 14, marginBottom: 14 },
  ...
  ctaBoxText: { fontFamily: 'Lora', fontSize: 11, color: '#FFFFFF', textAlign: 'center' },

  // Disclaimer (small, bottom)
  disclaimer: { fontFamily: 'Cormorant', fontSize: 8, color: '#999', textAlign: 'center', marginTop: 12, lineHeight: 1.4 },
});
