...
// ---- Margins matching cover border (Gemini border ~40px = ~30pt at 72dpi, + inner padding) ----
const M = { top: 65, right: 62, bottom: 60, left: 62 };
...
export async function generateSajuPdf({ report, coverImageBuffer, bodyImageBuffer, name, birthDate }) {
  ...
  const doc = el(Document, {},
    ...
    el(Page, { size: 'A4', style: { ...s.page, backgroundColor: IVORY } },
      el(View, { style: { ...s.body, justifyContent: 'center', alignItems: 'center' } },
