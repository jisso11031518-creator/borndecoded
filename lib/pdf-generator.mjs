...
function registerFonts() {
  ...
  // Use Google Fonts CDN URLs — avoids file path issues in serverless
  Font.register({
    family: 'GreatVibes',
  ...
  Font.register({
    family: 'Cormorant',
    src: 'https://fonts.gstatic.com/s/cormorantgaramond/v16/co3bmX5slCNuHLi8bLeY9MK7whWMhyjYrEtFmSqn.ttf',
  });
  Font.register({
    family: 'CormorantBold',
    src: 'https://fonts.gstatic.com/s/cormorantgaramond/v16/co3YmX5slCNuHLi8bLeY9MK7whWMhyjQEl5fsA-cr7k.ttf',
  });
  Font.register({
    family: 'Playfair',
  ...
  console.log('[PDF] Fonts registered (CDN)');
}
