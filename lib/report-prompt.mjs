...
- NEVER assign decision-making authority to one partner over another (e.g. "give [name] veto power" or "let [name] handle finances")
- Instead frame decisions as shared: "agree on a shared threshold that requires both partners' approval"
- Example BAD: "You'll be the stable provider in the partnership"
- Example BAD: "Give James veto power on major financial decisions"
- Example GOOD: "Your Earth energy naturally anchors the partnership's foundation"
- Example GOOD: "Set a shared spending threshold that requires both partners to agree"
...
8b. **TERM REFRAMING**: When using intimidating Saju terms, ALWAYS immediately follow with a positive reframe in parentheses on first mention:
   - Seven Killings → "Seven Killings energy (the catalyst that forces breakthrough growth)"
   - Hurting Officer → "Hurting Officer energy (the rebel spark that fuels creative innovation)"
   - Rob Wealth → "Rob Wealth energy (the competitive fire that sharpens your edge)"
   - MuGye combination → "MuGye (a rare stem harmony where your energies naturally combine)" — after first mention, use "stem harmonies" only.
   After the first parenthetical explanation, use the short form freely without repeating the reframe.
...

{
  ...
  "section9_yearTogether": {
    "title": "string — section title (e.g. 'Your Year Together')",
    "q1": "string — 2-3 sentences: Q1 (Jan-Mar) energy for this couple. What element dominates, what it means for them.",
    "q2": "string — 2-3 sentences: Q2 (Apr-Jun) energy. Opportunities and watch-outs.",
    "q3": "string — 2-3 sentences: Q3 (Jul-Sep) energy. Peak or tension period.",
    "q4": "string — 2-3 sentences: Q4 (Oct-Dec) energy. Closing energy and how to end the year strong."
  },
  "section10_questions": [
    {
  ...
  "section12_ritualIdeas": {
    "title": "string — section title (e.g. 'Ritual Ideas for Your Elements')",
    "ideas": [
      "string — 1-2 sentences: activity idea #1 tied to both people's elements. Light, fun, date-night tone.",
      "string — activity idea #2",
      "string — activity idea #3",
      "string — activity idea #4",
      "string — activity idea #5"
    ]
  },
  "coverArt": {
...
14. **COMPATIBILITY SCORE DISPLAY**: The score is provided in the data. Present it like: "You two scored [NUMBER] — the '[ZONE NAME]' zone..."
   - Below the score, add: "Scored on a 60\u2013120 scale: 60\u201369 Grounding Bond / 70\u201379 Growth Partnership / 80\u201389 Natural Harmony / 90\u2013100 Deep Resonance / 101+ Cosmic Alignment"
   - Then add: "Scores reflect elemental harmony, timing alignment, and day branch dynamics."
...
15. **QUESTIONS — WHAT-IF SCENARIOS (2 items)**: The section10_questions array MUST contain exactly 2 items.
...
export function buildSajuUserPrompt(sajuResult) {
  ...
  if (questions.fixed.job) context.job = questions.fixed.job;
