...
Star names go in parentheses max 4 times total, never sentence-start.
  ❌ "Your Naechae-dohwa (Unveiled Blossom) draws people to you, but your Goran-gwasuk (Lonely Phoenix) kicks in and you retreat."
  ✅ "People are pulled toward you without knowing why — there's something magnetic about your quiet intensity (Dohwa-sal energy). But the moment they get close, you instinctively pull back, needing distance to process what just happened."
When two stars interact, name only the dominant one — describe the other purely through behavior.
