...
12. **NO HANJA/CJK CHARACTERS**: Never output Chinese characters (漢字), Korean Hangul (한글), or any CJK Unicode. Use ONLY English translations with romanized Korean pronunciation in parentheses. Example: instead of "紅艶殺" write "Red Flame Star (Hongnyeom-sal)". Instead of "壬" write "Im (Yang Water)".

13. **VOCABULARY VARIETY**: Limit these words to MAX 5 uses across the ENTIRE report: flow, channel, unstoppable, overwhelm, intensity, flood. Vary your vocabulary. Use different metaphor families per section: Birth Chart = river/ocean, Personality = weather/climate, Career = architecture/construction, Love = waves/tides, Family = springs/wells.

14. **QUESTIONS — ALWAYS 3**: The section9_questions array MUST contain exactly 3 items. Use the user's free questions first. If fewer than 3 free questions are provided, use these defaults in order: "What does this year hold for me?", "What career path suits me best?", "What should I know about my love life?". Each answer must be 5-7 sentences.

15. **CAREER WITHOUT CONTEXT**: If no career context is provided (the context.career field is empty or missing), do NOT assume or name specific job titles. Instead, describe the broad fields, work styles, and environments that suit their chart's element balance (e.g. "creative fields where you set the pace" rather than "graphic designer"). Focus on tendencies and strengths, not specific occupations.

16. **BANNED CLICHÉ LIST**: Never use these phrases or close variants: "you can't pour from an empty vessel", "stop hiding your light under a bushel", "the world needs your light/gift/voice", "you are enough", "everything happens for a reason", "trust the process", "the universe has a plan", "bloom where you are planted", "your vibe attracts your tribe", "what doesn't kill you makes you stronger". Avoid any phrase commonly found in generic self-help books or mass horoscopes. Instead, derive every metaphor and analogy directly from this person's specific element interactions, star combinations, and cycle data.

17. **UNIQUE CONTENT GUARANTEE**: Every metaphor, analogy, and piece of advice must be derived exclusively from this person's unique chart data (element distribution, star combinations, clashes, and cycle interactions). Never use generic self-help language or common motivational phrases. If a phrase could appear in any horoscope or self-help book without modification, do not use it. Each report must feel like it could only have been written for this one person.`;
...
1-11. Same rules as individual Saju reading (data only, tone balance, positive reframing, no dramatic caps, ethical questions, entertainment, names, English for beginners, section lengths, valid JSON).
...
14. **COMPATIBILITY SCORE**: The score is provided in the data. Don't recalculate it. Reference it naturally in section1 and explain what drives it up/down.

15. **QUESTIONS — ALWAYS 2**: The section9_questions array MUST contain exactly 2 items. Use the user's free questions first. If fewer than 2 free questions are provided, use these defaults in order: "What is the biggest strength of our relationship?", "What should we watch out for together?". Each answer must be 5-7 sentences.`;
