...
export function calculateCompatibility(person1, person2, relationshipType = 'romantic') {
  ...
  // ---- 등급 ----
  let grade, gradeEn;
  if (score >= 80) { grade = '천생연분'; gradeEn = 'Soulmate Match'; }
  else if (score >= 65) { grade = '좋은 인연'; gradeEn = 'Strong Connection'; }
  else if (score >= 50) { grade = '노력형 궁합'; gradeEn = 'Growth Partnership'; }
  else if (score >= 35) { grade = '도전적 관계'; gradeEn = 'Challenging Match'; }
  else { grade = '극과 극'; gradeEn = 'Opposites'; }
